...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Role > Add</h6>
        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    @foreach($func as $key => $f)
                                        <tr class="text-center" >
                                           <td>{{ $key + 1}} <input class="hide" name="funcId" value="{{$f->func_id}}"/></td>
                                           <td class="text-left">{{ $f->func_name }}</td> 
                                           <td><input type="checkbox" name="per_view" /></td> 
                                           <td><input type="checkbox" name="per_add" /></td> 
                                           <td><input type="checkbox" name="per_edit" /></td> 
                                           <td><input type="checkbox" name="per_delete" /></td> 
                                           <td><input type="checkbox" name="per_import" /></td> 
                                           <td><input type="checkbox" name="per_export" /></td> 
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
