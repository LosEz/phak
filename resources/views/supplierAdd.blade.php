        ...
        <div class="card-body">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <span>แหล่งผลิต</span>
                            <input class="form-control" id="sourceProduct" />
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <span>มาตรฐาน GAP</span><br/>
                            <input type="radio" id="gapComplete" name="fav_language" value="C">
                            <label for="gapComplete">ได้รับ</label><br>
                            <input type="radio" id="gapProcess" name="fav_language" value="P">
                            <label for="gapProcess">กำลังดำเนินการ</label><br>
                            <input type="radio" id="gapUncomplete" name="fav_language" value="U">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="date" id="gapAppDate" />
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <button type="button" class="form-control btn btn-warning" onclick='window.location.href="{{ url("supplier") }}"'>Back</button>
                    </div>
                    <div class="col-sm-2">
